...
async function main() {
    ...
    try {
        ...
        console.log(`✅ Found! Number: ${result.index} → Hash: ${result.hashedExpression}`);
    }
    catch (err) {
