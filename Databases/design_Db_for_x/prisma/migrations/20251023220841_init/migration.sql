-- CreateEnum
CREATE TYPE "ProfileCategory" AS ENUM ('Education', 'Financial', 'Professional', 'Advertising', 'Science', 'Sport', 'Travel', 'Influencer', 'Entrepreneur', 'Community', 'Other');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('USER', 'SYSTEM');

-- CreateEnum
CREATE TYPE "LikeType" AS ENUM ('TWEET', 'COMMENT');
...
CREATE TABLE "Profile" (
    "id" TEXT NOT NULL,
    "bio" TEXT,
    "profileCategory" "ProfileCategory" NOT NULL,
...
-- CreateIndex
CREATE INDEX "Retweet_retweetUserId_idx" ON "Retweet"("retweetUserId");
...
-- AddForeignKey
ALTER TABLE "Retweet" ADD CONSTRAINT "Retweet_retweetUserId_fkey" FOREIGN KEY ("retweetUserId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
